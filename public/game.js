...
(() => {
  ...
  function buildGround() {
    // V21: terreno montado em paineis, sem ShapeGeometry/holes.
    // Isso cria duas aberturas FISICAS/visuais reais nas rampas da toca e
    // evita triangulos residuais do terreno cobrindo o jogador.
    const panels=[
      [-50,50,-42,-38],
      [-50,-45,-38,-11.5],[-39,50,-38,-11.5],
      [-50,50,-11.5,30.5],
      [-50,19.5,30.5,37.5],[45,50,30.5,37.5],
      [-50,50,37.5,42]
    ];
    for(const [x0,x1,z0,z1] of panels){
      ...
      ground.position.set((x0+x1)/2,-.06,(z0+z1)/2);
      ground.receiveShadow=true;ground.userData.mainGround=true;scene.add(ground);
    }
    // Traços decorativos somente na região central, longe das duas bocas.
  ...
  function buildRabbitTunnel(){
    ...
    // V21: sem pilares extras nas curvas; as paredes segmentadas fazem o fechamento.
  }
