...
(() => {
  ...
  // V56.27: viewmodels pretos para destacar contra os mapas claros/desenhados.
  for(const v of Object.values(weaponVariants))v.traverse(o=>{if(o.isMesh&&!o.userData.sniperLens&&o.material?.color){o.material.color.setHex(0x090a0c);if(o.material.emissive)o.material.emissive.setHex(0x000000);}});
  ...
  function makeRemotePlayer(state){
    ...
    for(const x of [-.20,.20]){
      ...
      boot.position.set(x,.13,-.07); group.add(boot);
    }
    ...
    mag.position.set(.16,1.06,-.68); mag.rotation.x=.10; gunGroup.add(mag); group.add(gunGroup);
