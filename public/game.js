...
(() => {
  ...
  for(const [kind,v] of Object.entries(weaponVariants)){
    ...
    const grips={
      rifle:{rear:[.39,-.56,-.60],front:[.40,-.43,-1.43],rearRoot:[1.08,-1.48,.34],frontRoot:[-.98,-1.46,.20]},
      sniper:{rear:[.39,-.58,-.83],front:[.40,-.43,-1.67],rearRoot:[1.10,-1.50,.40],frontRoot:[-1.02,-1.48,.16]},
      smg:{rear:[.40,-.58,-.68],front:[.41,-.43,-1.28],rearRoot:[1.05,-1.47,.38],frontRoot:[-.94,-1.44,.23]},
      shotgun:{rear:[.41,-.58,-.68],front:[.42,-.43,-1.76],rearRoot:[1.10,-1.50,.36],frontRoot:[-1.04,-1.48,.14]},
      launcher:{rear:[.39,-.58,-.95],front:[.40,-.43,-1.72],rearRoot:[1.12,-1.50,.44],frontRoot:[-1.04,-1.48,.15]}
    }[kind];
    const addViewLimb=(rootArr,ptArr,front=false)=>{
      ...
      const arm=addOutline(new THREE.Mesh(new THREE.CapsuleGeometry(.155,Math.max(.18,len-.30),4,8),sleeveMat),2.35);
  ...
  function makeRemotePlayer(state){
    ...
    const neck=new THREE.Mesh(new THREE.CylinderGeometry(.155,.205,.54,8),paperMat);
    neck.position.set(0,1.675,0); group.add(neck);
    const neckOutline=new THREE.Mesh(new THREE.CylinderGeometry(.164,.214,.542,8),new THREE.MeshBasicMaterial({color:0x08090b,side:THREE.BackSide}));
    ...
    trapezius.position.set(0,1.43,0); trapezius.scale.set(1.04,.72,.76); group.add(trapezius);
    ...
    const armBetween=(a,b)=>{
      ...
      const arm=addOutline(new THREE.Mesh(new THREE.CapsuleGeometry(.128,Math.max(.10,len-.24),4,8),accentMat),2.4);
    ...
    const shoulderL=new THREE.Vector3(-.55,1.43,-.005), shoulderR=new THREE.Vector3(.55,1.43,-.005);
