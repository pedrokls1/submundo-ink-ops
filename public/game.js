...
(() => {
  ...
  for(const v of Object.values(weaponVariants))v.traverse(o=>{if(o.isLineSegments)o.visible=false;});weaponVariants.sniper.visible=false; weaponVariants.smg.visible=false; weaponVariants.shotgun.visible=false; weaponVariants.launcher.visible=false; weaponVariants.knife.visible=false;
