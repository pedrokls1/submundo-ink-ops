...
(() => {
  ...
  function buildRabbitTunnel(){
    const pts=[[-40,-31],[-34,-24],[-34,-10],[-30,7],[-17,22],[4,29],[23,29],[34,24],[40,31]];
    ...
    window.__inkRabbitTunnelY=t=>{const ramp=.105;if(t<ramp)return 1.7-(t/ramp)*4.25;if(t>1-ramp)return 1.7-((1-t)/ramp)*4.25;return -2.55;};
