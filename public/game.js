...
(() => {
  ...
  for(const [kind,v] of Object.entries(weaponVariants)){
    ...
    const grips={rifle:{rear:[.39,-.56,-.60],front:[.40,-.43,-1.43]},sniper:{rear:[.39,-.58,-.83],front:[.40,-.43,-1.67]},smg:{rear:[.40,-.58,-.68],front:[.41,-.43,-1.28]},shotgun:{rear:[.41,-.58,-.68],front:[.42,-.43,-1.76]},launcher:{rear:[.39,-.58,-.95],front:[.40,-.43,-1.72]}}[kind];
  ...
  function makeRemotePlayer(state){
    ...
    const elbowL=new THREE.Vector3(-.34,1.25,-.38), elbowR=new THREE.Vector3(.36,1.22,-.22);
