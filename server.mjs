      ...
      try{
        ...
        if(m.action==='create'||m.action==='join'){
          ...
          if(m.action==='create'){
            ...
            r={code,status:'lobby',botsEnabled:false,map:'reino',host:null,players:new Map(),scores:{azul:0,vermelho:0},props:freshProps(),cat:{hp:180,respawnAt:0,warned:false},reward:{active:false,respawnAt:0,x:-27,z:24},matchStart:0,matchEnds:0,killLimit:40,winner:null};rooms.set(code,r);
